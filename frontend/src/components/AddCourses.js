...
const AddCourses = () => {
  ...
  const submitHandler = (e) => {
    ...
    formData.append('price', Number(price)); // Forces numeric value type
    ...
    .then(res => {
      ...
      setImage(null);
      setImageUrl(null);
      // Force refresh of Courses component
  ...
  return (
    <div>
      <form onSubmit={submitHandler} className='form'>
        ...
        <input onChange={e => setCourseName(e.target.value)} value={courseName} placeholder='Course-Name' type='text' />
        ...
        <input onChange={e => setStartingDate(e.target.value)} value={startingDate} placeholder='Starting Date (DD-MM-YY)' type='text' />
        <input onChange={e => setEndDate(e.target.value)} value={endDate} placeholder='End Date (DD-MM-YY)' type='text' />
